...
Cancelled Car Rentals Bookings | funziwallet
...
@endsection
        ...
        <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('admin.dashboard')}}">Home</a> /View /</span> All Cancelled Car Rentals Bookings List ( {{ count($bookings) }} Booking)
            </h4>
...
<span class="badge badge-pill badge-warning" style="background: rgb(246, 28, 28);">{{$value->status}}</span>
