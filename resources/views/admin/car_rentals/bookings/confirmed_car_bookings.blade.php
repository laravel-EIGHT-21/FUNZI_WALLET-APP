...
Confirmed Car Rentals Bookings | funziwallet
...
@endsection
        ...
        <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('admin.dashboard')}}">Home</a> /View /</span> All Confirmed Car Rentals Bookings List ( {{ count($bookings) }} Booking)
            </h4>
