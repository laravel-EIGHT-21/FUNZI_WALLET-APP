...
@endsection
        ...
        <div class="container-xxl flex-grow-1 container-p-y"> 
            ...
            <h4 class="py-3 mb-4">
                <span class="text-muted fw-light"><a href="{{route('admin.dashboard')}}">Orders</a> /View/</span> Confirmed Orders List ( {{ count($orders) }} Orders)
              </h4>
...
<td>
    ...
    <div class="d-flex align-items-center">
    <div class="ms-3">
    <h6 class="fw-semibold mb-0">{{ $value->confirmed_date}}</h6>
