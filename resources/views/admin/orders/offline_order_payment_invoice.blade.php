...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.77295 16.3566L23.6563 0H32V6.88383C32 6.88383 31.8262 9.17836 30.6591 10.4057L19.7824 22H13.6938L7.77295 16.3566Z" fill="#7367F0" />
  ...
  <div>
    <h4 class="fw-medium">Order No #{{$offline_details['0']['order']['order_number']}}</h4>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td>{{$offline_details['0']['school']['address']}}</td>
        </tr>
      </tbody>
    </table>
  </div>
  <div class="col-sm-6 w-50">
    ...
    <table>
      ...
      <tr>
        ...
        <td>{{$offline_details['0']['order']['order_number']}}</td>
      </tr>

      <tr>
        <td class="pe-3">Total Items:</td>
        <td>{{$offline_details['0']['order']['total_order_items']}}</td>
      </tr>

      <tr>
        <td class="pe-3">Date :</td>
        <td>{{$offline_details['0']['order']['order_date']}}</td>
      </tr>

      <tr>
        <td class="pe-3">Order Time :</td>
        <td>{{$offline_details['0']['order']['order_time']}}</td>
      </tr>

      <tr>
        <td class="pe-3">Order Status :</td>
        <td>{{$offline_details['0']['order']['status']}}</td>
      </tr>
