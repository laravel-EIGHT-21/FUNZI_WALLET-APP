...
@endcan
      ...
      <div class="card">
                                  <div class="card-body">
                                    ...
                                    <div class="row"> 
                                      ...
                                      <a href="{{ route('make.order.offline.payment',$orders['0']['id']) }}" target="_blank" class="btn rounded-pill btn-warning">
                                      <span class="d-flex align-items-center justify-content-center text-nowrap"><i class="mdi mdi-currency-usd scaleX-n1-rtl me-1"></i>Make Order Payment</span>
                                      </a>
  ...
  <td>
    ...
    <a href="{{route('offline.order.payment.edit',$value->order_id)}}" title="Edit Amount" target="_blank" class="btn btn-sm btn-success"><i class='mdi mdi-square-edit-outline '></i></a>
