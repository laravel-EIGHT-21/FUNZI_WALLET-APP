...
@endsection
        ...
        <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('admin.dashboard')}}">Orders</a> /View/</span> Shipped Orders List ( {{ count($orders) }} Orders)
            </h4>
...
<div class="d-flex align-items-center">
<div class="ms-3">
<h6 class="fw-semibold mb-0">{{ $value->shipped_date}}</h6>
