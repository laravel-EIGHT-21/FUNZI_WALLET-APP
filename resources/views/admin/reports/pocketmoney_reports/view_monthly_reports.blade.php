...
Monthly PocketMoney Transations Report
...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Transactions</a> /View/</span>Monthly PocketMoney Transactions Reports
            </h4>
...
<div class="row">
                        ...
                        <h4 class="text"><b>Monthly Reports</b></h4>
                      ...
                      <div class="col-xl">
                          ...
                          <div class="card-body">
                            <form method="post" action="{{ route('search-pocketmoney-deposits-by-month') }}">
                              @csrf
                    ...
                    <div class="row">
                      <div class="col-xl-12">
                      <h4 class="text"><b>PocketMoney Deposits Monthly Reports</b></h4>
