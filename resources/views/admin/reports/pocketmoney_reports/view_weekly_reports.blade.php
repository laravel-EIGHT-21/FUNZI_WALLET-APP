...
Weekly / Daily PocketMoney Transations Report
...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Transactions</a> /View/</span>Weekly PocketMoney Transactions Reports
            </h4>
...
<div class="row">
                        ...
                        <h4 class="text"><b>Weekly Reports</b></h4>
                      ...
                      <div class="col-xl">
                          ...
                          <div class="card-body">
                          <form method="post" action="{{ route('search-pocketmoney-deposits-by-week') }}">
                                                                      @csrf
                              <div class="form-floating form-floating-outline mb-4">
                                <input class="form-control" type="date" name="start_date" id="start_date" value="{{@$sdate}}" required />
                                <label for="start_date">Enter Start Date</label>
                              </div>
                              <div class="form-floating form-floating-outline mb-4">
                                <input class="form-control" type="date" name="end_date" id="end_date" value="{{@$edate}}" required />
                    ...
                    <div class="row">
                      <div class="col-xl-12">
                      <h4 class="text"><b>PocketMoney Weekly/Daily Reports</b></h4>
                    ...
                    $school= App\Models\students_pocketmoney::where('school_id',$value->school_id)->get();
                    $depo_total = App\Models\students_pocketmoney::where('school_id',$value->school_id)->where('transfer_date',$value->transfer_date)->sum('amount');
...
pointHighlightStroke: 'rgba(255, 165, 0,0.8)',
borderWidth: 2,
