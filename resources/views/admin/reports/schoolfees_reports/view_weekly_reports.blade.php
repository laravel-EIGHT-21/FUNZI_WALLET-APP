...
Weekly / Daily SchoolFees Transations Report
...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Transactions</a> /View/</span>Weekly SchoolFees Transactions Reports
            </h4>
...
<br/>
  ...
  <div class="col-xl">
      ...
      <div class="card-body">
      <form method="post" action="{{ route('search-schoolfees-deposits-by-week') }}">
                                                  @csrf
