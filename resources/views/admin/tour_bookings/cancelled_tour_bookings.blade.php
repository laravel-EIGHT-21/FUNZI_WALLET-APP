...
Cancelled Tour Bookings | funziwallet
...
@endsection
        ...
        <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Home</a> /View /</span> All Cancelled Tour Bookings List ( {{ count($bookings) }} Booking)
            </h4>
...
<span class="badge badge-pill badge-warning" style="background: red;">{{$value->status}}</span>
