...
Pending Tour Bookings | funziwallet
...
@endsection
        ...
        <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Home</a> /View /</span> All Pending Tour Bookings List ( {{ count($bookings) }} Booking)
            </h4>
