...
<head>
    ...
    <title> Tour Booking Payment Track | Report Print</title>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.77295 16.3566L23.6563 0H32V6.88383C32 6.88383 31.8262 9.17836 30.6591 10.4057L19.7824 22H13.6938L7.77295 16.3566Z" fill="#7367F0" />
  ...
  <div>
    <h4 class="fw-medium">Booking No #{{$payment_details['0']['booking']['booking_number']}}</h4>
...
<div class="row">
  <div class="col-12">
    ...
    <span>TOUR BOOKING PAYMENT TRACKING INVOICE </span>
  </div>
</div>
  ...
  <div class="col-sm-6 w-50">
    ...
    <table>
      ...
      <tr>
        ...
        <td>{{$payment_details['0']['booking']['booking_number']}}</td>
      </tr>

      <tr>
        <td class="pe-3">Total Tours:</td>
        <td>{{$payment_details['0']['booking']['total_tours']}}</td>
      </tr>

      <tr>
        <td class="pe-3">Date :</td>
        <td>{{$payment_details['0']['booking']['booking_date']}}</td>
      </tr>
...
<br /><br />
<h6><b>Tour Booking Payments Tracking Details</b></h6>
