...
$tours = App\Models\tour_packages::where('status',1)->get();

$tours_confirmed = App\Models\tours_packs::where('status','Bookings Confirmed')->where('year',$years)->get();


$tours_cancelled = App\Models\tours_packs::where('status','Bookings Cancelled')->where('year',$years)->get();
...
<br/>
  ...
  <div class="col-xl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="post" action="{{ route('search-school-tour-booking-by-year') }}">
          @csrf
        ...
        <label for="html5-month-input">Year</label>
          ...
          <a href="{{ route('all.tour.bookings.reports')}}"  class="btn btn-success">Reset</a>
        </form>
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="card">
            ...
            <tr>
                ...
                $stud_price_total_yearly = App\Models\tours_packs::where('month',$value->month)->sum('stud_pricetotal');


                $adult_price_total_yearly = App\Models\tours_packs::where('month',$value->month)->sum('adult_pricetotal');
