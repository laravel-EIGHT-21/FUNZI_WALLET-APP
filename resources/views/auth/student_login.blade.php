...
<head>
    ...
    <title>Students Login - funziwallet</title>
    ...
    <defs>
      ...
      <linearGradient id="paint1_linear_2989_100980" x1="5.19475" y1="0.849139" x2="10.3357" y2="24.1155" gradientUnits="userSpaceOnUse">
        ...
        <div class="card-body mt-1">
            ...
            <h5 class="mb-2">Student Login </h5>
            ...
            <div class="mb-5 d-flex justify-content-between mt-5">
              ...
              @if (Route::has('students.password.request'))
              <a href="{{ route('students.password.request') }}" class="float-end mb-1 rounded-md text-primary-800">
