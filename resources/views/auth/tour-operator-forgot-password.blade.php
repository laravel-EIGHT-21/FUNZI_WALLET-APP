...
<head>
    ...
    <title>Funzi Wallet App | Forgot Password </title>
    ...
    <defs>
      ...
      <linearGradient id="paint1_linear_2989_100980" x1="5.19475" y1="0.849139" x2="10.3357" y2="24.1155" gradientUnits="userSpaceOnUse">
        ...
        <div class="card-body mt-2">
          <h4 class="mb-2">Tour Operator Forgot Password? 🔒</h4>
          <p class="mb-4">Enter your email and we'll send you instructions to reset your password</p>
          
          <form id="formAuthentication" method="POST" action="{{ route('tour.operator.password.email') }}"  class="mb-3">
          @csrf
      ...
      <!-- /Forgot Password -->
      <img alt="mask" src="{{asset('Admin/assets/img/illustrations/auth-basic-forgot-password-mask-light.png')}}" class="authentication-image d-none d-lg-block" data-app-light-img="illustrations/auth-basic-forgot-password-mask-light.png" data-app-dark-img="illustrations/auth-basic-forgot-password-mask-dark.html" />
    </div>
  </div>
</div>
