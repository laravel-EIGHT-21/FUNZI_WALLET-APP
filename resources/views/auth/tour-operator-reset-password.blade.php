           <!DOCTYPE html>
                ...
                <head>
                    ...
                    <title>Funzi Wallet App | Reset Password </title>
                  ...
                  <svg width="268" height="150" viewBox="0 0 38 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <defs>
                      ...
                      <linearGradient id="paint1_linear_2989_100980" x1="5.19475" y1="0.849139" x2="10.3357" y2="24.1155" gradientUnits="userSpaceOnUse">
                        ...
                        <!-- Reset Password -->
                        <div class="card-body">
                          <h4 class="mb-2">Tour Operator Reset Password 🔒</h4>
                          <p class="mb-4">Your new password must be different from previously used passwords</p>

                          <form id="formAuthentication" class="mb-3" method="POST" action="{{ route('tour.operator.reset.password.update') }}">
                          @csrf
                      ...
                      <!-- /Reset Password -->
                      <img alt="mask" src="{{asset('Admin/assets/img/illustrations/auth-basic-reset-password-mask-light.png')}}" class="authentication-image d-none d-lg-block" data-app-light-img="illustrations/auth-basic-reset-password-mask-light.png" data-app-dark-img="illustrations/auth-basic-reset-password-mask-dark.html" />
                    </div>
                  </div>
                </div>
