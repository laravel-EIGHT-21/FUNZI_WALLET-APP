...
<span style="color:var(--bs-primary);">
  <svg width="268" height="150" viewBox="0 0 38 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">funzi rentals</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    <!-- Dashboards -->
    <li class="menu-item {{($route == 'school.car.rentals.dashboard')? 'active':''}}">
      <a href="{{route('school.car.rentals.dashboard')}}" class="menu-link ">
    ...
    <!-- School Tours -->
    <li class="menu-item {{($route == 'school.car.rentals')? 'active':''}}">
      ...
      <ul class="menu-sub">
        <li class="menu-item {{($route == 'school.car.rentals')? 'active':''}}">
          <a href="{{route('school.car.rentals')}}" class="menu-link" >
            <div data-i18n="All Bus Rentals">All Bus Rentals</div>
          </a>
        </li>

        <li class="menu-item {{($route == 'filter.car.rentals')? 'active':''}}">
          <a href="{{route('filter.car.rentals')}}" class="menu-link" >
            <div data-i18n="Filter Bus">Filter Bus</div>
          </a>
        </li>

        <li class="menu-item {{($route == 'view.bus.rental.bookings')? 'active':''}}">
          <a href="{{route('view.bus.rental.bookings')}}" class="menu-link">
            <div data-i18n="Rental Bookings">Rental Bookings</div>
          </a> 
        </li>


        <li class="menu-item {{($route == 'view.car.rental.cart')? 'active':''}}">
          <a href="{{route('view.car.rental.cart')}}" class="menu-link">
            <div data-i18n="Bus Rental Cart">Bus Rental Cart</div>
          </a>
        </li>

        
        
        <li class="menu-item {{($route == 'view.rental.booking.payments')? 'active':''}}">
          <a href="{{route('view.rental.booking.payments')}}" class="menu-link">
            <div data-i18n="Booking Payments">Booking Payments</div>
          </a>
        </li>
