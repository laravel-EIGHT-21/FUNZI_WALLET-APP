...
<head>
    ...
    <title> Bus Rental Bookings - Details | Report Print</title>
...
<div class="row">
  <div class="col-12">
    ...
    <span><b>RENTAL BOOKINGS DETAILS REPORT</b></span>
  </div>
</div>
      ...
      <tr>
        <td>
          ...
          <div class="d-flex align-items-center">
            <img src="{{ (!empty($value['rental']['car_photo']))? url('upload/car_photos/'.$value['rental']['car_photo']):url('upload/no_image.jpg') }}" class="rounded-circle" alt="Product Image" width="50" height="50">

            <div class="ms-3">
              <h6 class="fw-bold mb-0 fs-6">{{$value->rental->car_name}}</h6>
