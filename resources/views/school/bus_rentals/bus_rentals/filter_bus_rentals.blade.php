...
@endsection
        ...
        <!-- Content -->
          ...
          <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('school.car.rentals.dashboard')}}">Home</a>/</span>Filter Bus Rentals</h4>

          <br/>   <br/>


          <h4 class="text"><b>Filter Bus Rental</b></h4>
            
<div class="app-academy">
  <div class="card p-0 mb-4">
    <div class="card-body">
        <form method="GET" action="{{ route('car.rentals.filtered') }}">
        ...
        <div class="col-md-6">
          ...
          <a href="{{ route('filter.car.rentals')}}"  class="btn btn-success">Reset</a>
        </form>
      </div>
  </div>
...
<div class="row">
  <div class="col-xl-12">
    <h5 class="text-bold">All Bus Rentals Available </h5>
