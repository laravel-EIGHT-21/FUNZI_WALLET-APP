...
Rentals Booking Confirmation | funziwallet
...
@endsection
        ...
        <h4 class="py-3 mb-4">
              <span class="text-muted fw-light">Bus Rental Ecommerce /</span>Bus Rental Booking Confirmation
            </h4>
              ...
              <div class="bs-stepper-header m-auto border-0">
                <div class="step" data-target="#checkout-cart">
                  <button type="button" class="step-trigger">
                    <span class="bs-stepper-label">Confirm Bus Rental Booking Payments</span>
                  </button>
                </div>
                          ...
                          <div class="tab-content p-0" id="paymentTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="mtn-momo" role="tabpanel" aria-labelledby="mtn-momo-tab">
                              <div class="row g-5">
                                ...
                                <form action="{{ route('submit.bus.rental.bookings') }}" method="post" id="ConfirmOrder" >
                                  @csrf
                      ...
                      <div class="col-xl-4">
                        <div class="border rounded p-3 mb-3">
                          ...
                          <dl class="row mb-0">
                            ...
                            <dt class="col-6 fw-normal text-heading">Rental Bookings</dt>
