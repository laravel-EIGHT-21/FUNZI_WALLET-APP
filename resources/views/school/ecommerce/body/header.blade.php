        ...
        <div class="header-top-inner">
          <div class="cnt-account">
            <ul class="list-unstyled">
              ...
              <li><a href="{{ route('view.school.orders')}}"><i class="icon fa fa-align-justify fa-fw"></i>Orders</a></li>
            </ul>
          </div>
          <!-- /.cnt-account -->
      ...
      <div class="container"> 
        <div class="row">
          <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
            <!-- ============================================================= LOGO ============================================================= -->
            <div class="logo"> <a href="{{ route('school.ecommerce.dashboard')}}"> <img src="{{asset('eCOMM/assets/images/logo.png')}}" alt=""> </a> </div>
            <!-- /.logo --> 
            <!-- ============================================================= LOGO : END ============================================================= --> </div>
          <!-- /.logo-holder -->
       ...
       <button class="search-button" type="submit"></button> </div>
          ...
          <div class="col-xs-12 col-sm-12 col-md-2 animate-dropdown top-cart-row"> 
            ...
            $totalcartpx = App\Models\order_carts::where('school_id',$school_id)->sum('pricetotal');
              ...
              <ul class="dropdown-menu">
                <li>
                  ...
                  <div class="cart-item product-summary">
                    <div class="row">
                      <div class="col-xs-6">
                        <div class="image"> <img src="{{ (!empty($cart['product']['product_thambnail']))? url('upload/product_images/'.$cart['product']['product_thambnail']):url('upload/no_image.jpg') }}" alt class="w-px-50 h-px-50 rounded-circle"></div>
                      </div>
                      <div class="col-xs-8">
                        <h4 class="name">{{$cart['product']['product_name']}}</h4>
                        @php 
      
                        $product_price = (float)$cart->price * (float)$cart->qty;
  
                        @endphp
                        <div class="price">ugx {{$product_price}}</div>
                      </div>
                      <div class="col-xs-1 action">
                         <button type="button" onclick="removeItemFromCart('{{$cart->id}}')"><i class="fa fa-trash"></i></button> 
