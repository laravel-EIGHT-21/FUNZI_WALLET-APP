...
Order Confirmation | funziwallet
...
@endsection
        ...
        <h4 class="py-3 mb-4">
          <span class="text-muted fw-light">Ecommerce /</span> Order Confirmation
            </h4>
              ...
              <div class="bs-stepper-header m-auto border-0">
                <div class="step" data-target="#checkout-cart">
                  <button type="button" class="step-trigger">
                    <span class="bs-stepper-label">Confirm Order Payments</span>
                  </button>
                </div>
                                ...
                                <div class="col-12">
                                  ...
                                  <div class="input-group input-group-merge">
                                    <div class="form-floating form-floating-outline">
                                      <input id="paymentCard" name="phone_number" class="form-control" type="text" placeholder="077,078,076...etc" />
