...
<head>
    ...
    <title>Expense Category Termly Report | Print</title>
...
<br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h6><u>EXPENSE CATEGORY TERMLY REPORT FOR TERM : {{$details['term']['name']}} | YEAR : {{$details['year']}}</u></h6>
              </div>
            </div>
                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td class="fw-medium">{{$details['school']['name']}}</td>
                    </tr>
                    <tr>
                      <td class="pe-3">School ID:</td>
                      <td>{{$details['school']['school_id_no']}}</td>
                    </tr>
                    <tr>
                      <td class="pe-3">Tel 1:</td>
                      <td>{{$details['school']['school_tel1']}}</td>
                    </tr>
                    <tr>
                      <td class="pe-3">Tel 2:</td>
                      <td>{{$details['school']['school_tel2']}}</td>
                    </tr>
                    <tr>
                      <td class="pe-3">Address:</td>
                      <td>{{$details['school']['school_address']}}</td>
                    </tr>
                  </tbody>
                </table>
                      </div>
                      ...
                      <div class="my-3">
                      <h6><u>Expense Category :</u></h6>
                <table>
                  <tbody>
                    <tr>
                      <td class="pe-3">Category:</td>
                      <td class="fw-medium">{{$details['category']['name']}}</td>
                    </tr>
