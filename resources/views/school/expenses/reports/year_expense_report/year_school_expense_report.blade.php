...
<head>
    ...
    <title>Yearly School Expenses | Report Print</title>
...
<br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h5><u>YEARLY SCHOOL EXPENSES REPORT FOR YEAR : {{$school_details['year']}}</u></h5>
              </div>
            </div>
      ...
      $term = App\Models\expenses::where('term_id',$value->term_id)->orderBy('id','desc')->get();

	  $total_amount_paid = App\Models\expenses::where('term_id',$value->term_id)->where('category_id',$value->category_id)->where('year',$value->year)->sum('amount');
    
    
	  $total_amount = App\Models\expenses::where('term_id',$value->term_id)->where('category_id',$value->category_id)->where('year',$value->year)->sum('invoice_amount');
