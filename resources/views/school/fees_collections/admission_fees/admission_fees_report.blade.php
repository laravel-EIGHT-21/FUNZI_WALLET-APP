...
Admission Fees Collections Reports
...
$term_one_fees = DB::table('admissions')->where('school_id',$school_code)->where('term_id',1)->where('year',$years)->sum('admission_fees');

$term_two_fees = DB::table('admissions')->where('school_id',$school_code)->where('term_id',2)->where('year',$years)->sum('admission_fees');

$term_three_fees = DB::table('admissions')->where('school_id',$school_code)->where('term_id',3)->where('year',$years)->sum('admission_fees');
...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}"> Home  </a>/View/</span> Admission Fees Collections Reports
            </h4>
...
<h5 class="py-3 mb-2"> All Admission Fees Collections for Year {{$years}}</h5>
<div class="row gy-4">
...
<div class="row">
                        ...
                        <h5 class="text">Admission Fees Collections By Term</h5>
    <div class="card mb-6">
...
<div class="card-body">
<form method="POST" action="{{ route('search-admission-fees-by-term') }}" target="_blank">
@csrf
<div class="row">
...
<div class="row">
                        ...
                        <h5 class="text">Admission Fees Collections By Year</h5>
    <div class="card mb-6">
...
<div class="card-body">
<form method="POST" action="{{ route('search-admission-fees-by-year') }}" target="_blank">
@csrf
<div class="row">
