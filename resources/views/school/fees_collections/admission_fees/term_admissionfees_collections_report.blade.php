...
<head>
    ...
    <title>Termly Admission Fees Collection | Report Print</title>
...
<br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h6><u>TERMLY ADMISSION FEES COLLECTIONS REPORT FOR TERM : {{$admissionfees['0']['term']['name']}} | YEAR : {{$admissionfees['0']['year']}}</u></h6>
              </div>
            </div>
              ...
              @php
                ...
                $total_amount_paid = App\Models\admissions::where('term_id',$value->term_id)->where('student_class',$value->student_class)->where('year',$value->year)->sum('admission_fees');
