...
<head>
    ...
    <title>Yearly Admission Fees Collection | Report Print</title>
...
<br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h5><u>YEARLY ADMISSION FEES COLLECTIONS REPORT FOR YEAR : {{$admissionfees['0']['year']}}</u></h5>
              </div>
            </div>
                ...
                @foreach($admissionfees as $key => $value )
                  ...
                  @php
      $term= App\Models\admissions::where('term_id',$value->term_id)->orderBy('id','desc')->get();

	  $total_amount_paid = App\Models\admissions::where('term_id',$value->term_id)->where('year',$value->year)->sum('admission_fees');
                      ...
                      <div class="col-md-6 d-flex justify-content-md-end mt-2">
                        <div class="invoice-calculations">
                          <div class="d-flex justify-content-between mb-2">
                            ...
                            <h6 class="mb-0 pt-1">ugx {{$total_fees}}</h6>
                          </div>
