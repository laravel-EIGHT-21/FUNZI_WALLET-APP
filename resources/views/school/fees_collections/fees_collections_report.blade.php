...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7.77295 16.3566L23.6563 0H32V6.88383C32 6.88383 31.8262 9.17836 30.6591 10.4057L19.7824 22H13.6938L7.77295 16.3566Z" fill="#7367F0" />
  ...
  <div>
    <h4 class="fw-medium">Invoice No #{{$details['0']['invoice_no']}}</h4>
...
<div class="row">
  <div class="col-12">
    ...
    <span>STUDENT SCHOOLFEES PAYMENT INVOICE FOR :&nbsp; <b> {{$details['0']['term']['name']}} &nbsp; | &nbsp; {{$details['0']['year']}} </b> </span>
  </div>
</div>
    ...
    <table>
      <tbody>
        <tr>
          ...
          <td class="fw-medium">{{$details['0']['school']['name']}}</td>
        </tr>

        <tr>
          <td class="pe-3">Tel 1:</td>
          <td>{{$details['0']['school']['school_tel1']}}</td>
        </tr>
        <tr>
          <td class="pe-3">Tel 2:</td>
          <td>{{$details['0']['school']['school_tel2']}}</td>
        </tr>
        <tr>
          <td class="pe-3">Address:</td>
          <td>{{$details['0']['school']['school_address']}}</td>
        </tr>
      </tbody>
    </table>
  </div>
    ...
    <table>
      ...
      <tr>
        ...
        <tr>
          ...
          <td>{{$details['0']['student']['student_code']}}</td>
        </tr>

        <tr>
          <td class="pe-3">Current Class :</td>
          <td>{{$details['0']['student_class']}}</td>
        </tr>

        <tr>
          <td class="pe-3">Section :</td>
          <td>{{$details['0']['student_day_boarding']}}</td>
        </tr>
...
<div class="table-responsive">
    ...
    <tbody>
      ...
      <tr>
                  <td>UGX {{ $details['0']['amount']}}</td>	
                  <td>UGX {{ $details['0']['total_amount']}}</td>
                  
                  @php 

                  $bal=(float)$details['0']['total_amount']-$details['0']['amount'];
