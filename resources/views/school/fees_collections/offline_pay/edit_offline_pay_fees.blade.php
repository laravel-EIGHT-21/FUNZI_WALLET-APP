...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light">SchoolFees / Payment /</span> Update Student`s  Offline Payment
            </h4>
...
<a href="{{ route('view.fees.collections')}}" class="btn rounded-pill btn-primary" style="float:right;"><i class='tf-icons mdi mdi-arrow-left mdi-20px'></i>Back</a>
            ...
            <div class="row">
              ...
              <div class="col-xl-6 col-lg-7 col-md-7 order-0 order-md-1">
                  ...
                  <div class="card mb-4">
                  <h5 class="card-header">Update Offline Payment Information Below</h5>
                  <div class="card-body">
                  <form action="{{ route('student.fees.update.store',$editFees->id) }}" method="POST" >
                  @csrf

                  <input type="hidden" name="id" value="{{ $editFees->id }}" />
                  ...
                  <input class="form-control" type="text" name="amount" value="{{$editFees->amount}}" id="cash" required />
                  ...
                  <div class="col mb-4 mt-2">
                  <div class="form-floating form-floating-outline">
                  <input class="form-control" type="text" name="year" required value="{{$editFees->year}}" id="html5-text-input" />
            ...
            <label for="term_id">School Terms</label>
                ...
                <option value="BankSlip" {{ ($update->payment_type == 'BankSlip')? 'selected':'' }}>Bank Slip</option>
