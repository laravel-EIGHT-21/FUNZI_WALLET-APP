...
<head>
    ...
    <title> Student Yearly Schoolfees Financial Statement | Report Print</title>
...
<div class="row">
  <div class="col-12">
    ...
    <h6><u>STUDENT TERMLY SCHOOLFEES FINANCIAL STATEMENT REPORT FOR YEAR : {{$total_schoolfees['0']['year']}}</u></h6>
  </div>
</div>
...
<h6><b>All SchoolFees Payments Details</b></h6>
 <div class="table-responsive">
    ...
    @foreach($total_schoolfees as $key => $value )
    <tbody>
