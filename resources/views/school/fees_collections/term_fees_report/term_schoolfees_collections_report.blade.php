...
<head>
    ...
    <title>Termly SchoolFees Collection | Report Print</title>
...
<br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h6><u>TERMLY SCHOOLFEES COLLECTIONS REPORT FOR TERM : {{$school_details['term']['name']}} | YEAR : {{$school_details['year']}}</u></h6>
              </div>
            </div>
              ...
              @php
                ...
                $total_amount_paid = App\Models\students_schoolfees_records::where('term_id',$value->term_id)->where('student_class',$value->student_class)->where('year',$value->year)->sum('amount');
                
                $total_amount = App\Models\students_schoolfees_records::where('term_id',$value->term_id)->where('student_class',$value->student_class)->where('year',$value->year)->sum('total_amount');
