...
$term_one_expense = DB::table('expenses')->where('school_id',$school_id)->where('term_id',1)->where('year',$years)->sum('amount');

$term_two_expense = DB::table('expenses')->where('school_id',$school_id)->where('term_id',2)->where('year',$years)->sum('amount');

$term_three_expense = DB::table('expenses')->where('school_id',$school_id)->where('term_id',3)->where('year',$years)->sum('amount');
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center flex-wrap gap-2">
          ...
          <div class="card-info">
            <div class="d-flex align-items-center">
              <h4 class="mb-0">UGX {{ ($term_one_expense) }}</h4>
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center flex-wrap gap-2">
          ...
          <div class="card-info">
            <div class="d-flex align-items-center">
              <h4 class="mb-0">UGX {{ ($term_two_expense) }}</h4>
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center flex-wrap gap-2">
          ...
          <div class="card-info">
            <div class="d-flex align-items-center">
              <h4 class="mb-0">UGX {{ ($term_three_expense) }}</h4>
...
<div class="row">
                        ...
                        <h5 class="text">Income Statement By Term</h5>
    <div class="card mb-6">
...
<div class="row">
                        ...
                        <h5 class="text">Income Statement By Year</h5>
    <div class="card mb-6">
