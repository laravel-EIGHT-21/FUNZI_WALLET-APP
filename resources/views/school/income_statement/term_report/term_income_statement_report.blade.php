...
<head>
    ...
    <title>Termly School Income Statement | Report Print</title>
    ...
    <br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h6><u>TERMLY INCOME STATEMENT REPORT FOR TERM : {{$school_details['term']['name']}} | YEAR : {{$school_details['year']}}</u></h6>
              </div>
            </div>
            ...
            $expense_paid = App\Models\expenses::where('term_id',$exp->term_id)->where('category_id',$exp->category_id)->where('year',$exp->year)->sum('amount');
