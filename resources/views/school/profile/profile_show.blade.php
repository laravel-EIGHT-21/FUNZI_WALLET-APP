    ...
    <div class="tab-content">
      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          <img src="{{ (!empty($adminData->profile_photo_path))? url('upload/logo/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" alt="user-avatar" class="d-block w-px-120 h-px-120 rounded" id="uploadedAvatar" />
          ...
          <div class="row mt-2 gy-4">
            ...
            <div class="col-md-6">
              <div class="input-group input-group-merge">
                <div class="form-floating form-floating-outline">
                  <input type="text" id="school_tele" name="school_tel1" class="form-control" maxlength="10" minlength="10" value="{{$editData->school_tel1}}" placeholder="070000000" required />
                  <label for="school_tele">Telephone One</label>
                </div>
            ...
            <div class="col-md-6">
              <div class="input-group input-group-merge">
                <div class="form-floating form-floating-outline">
                  <input type="text" id="school_tele" name="school_tel2" class="form-control" maxlength="10" minlength="10" value="{{$editData->school_tel2}}" placeholder="070000000" required />
                  <label for="school_tele">Telephone Two</label>
                </div>
            ...
            <div class="col-md-6">
              <div class="input-group input-group-merge">
                <div class="form-floating form-floating-outline">
                  <input type="text" id="sch_addres" name="address" class="form-control" value="{{$editData->address}}" required />
                  <label for="sch_addres">Address</label>
                </div>
