...
<head>
    ...
    <title> Purchase Details | Report Print</title>
...
<div class="row">
  <div class="col-12">
    ...
    <h6>PURCHASE INVOICE REPORT : &nbsp; {{$details['0']['term']['name']}} &nbsp; | &nbsp; {{$details['0']['year']}} </h6>
  </div>
</div>
...
<div class="col-sm-6 w-50">
  ...
  <div class="col-sm-6 w-50">
    ...
    <table>
      <tbody>
      <tr>
          <td class="pe-3">Purchase :</td>
          <td>{{$details['0']['purchase']['name']}}</td>
        </tr>
...
<div class="table-responsive">
    ...
    <tbody>
      ...
      <tr>
                  <td>UGX {{ $details['0']['unit_price']}}</td>	
                  <td>UGX {{ $details['0']['total_price']}}</td>
                  <td>{{ $details['0']['supplier']}}</td>
                  <td>{{ $details['0']['item_qty']}}</td>
