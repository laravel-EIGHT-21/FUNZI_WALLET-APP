...
<head>
    ...
    <title>Purchased Item Termly Report | Print</title>
...
<br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h6><u>PURCHASED ITEM TERMLY REPORT FOR TERM : {{$details['term']['name']}} | YEAR : {{$details['year']}}</u></h6>
              </div>
            </div>
                ...
                <table>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <div class="my-3">
                      <h6><u>Purchased Item :</u></h6>
                <table>
                  <tbody>
                    <tr>
                      <td class="pe-3">Item :</td>
                      <td class="fw-medium">{{$details['purchase']['name']}}</td>
                    </tr>
                      ...
                      <div class="col-md-6 d-flex justify-content-md-end mt-2">
                        <div class="invoice-calculations">
                          <div class="d-flex justify-content-between mb-2">
                            <span class="w-px-150">Grand Total Price:</span>
                            <h6 class="mb-0 pt-1">ugx {{$total_price}}</h6>
                          </div>
