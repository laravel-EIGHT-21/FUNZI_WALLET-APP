...
<head>
    ...
    <title>Yearly School Purchases | Report Print</title>
...
<br/>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <h5><u>YEARLY SCHOOL PURCHASES REPORT FOR YEAR : {{$school_details['year']}}</u></h5>
              </div>
            </div>
      ...
      $term = App\Models\purchaseStocks::where('term_id',$value->term_id)->orderBy('id','desc')->get();

	  $grand_total_price = App\Models\purchaseStocks::where('term_id',$value->term_id)->where('purchase_id',$value->purchase_id)->where('year',$value->year)->sum('total_price');
