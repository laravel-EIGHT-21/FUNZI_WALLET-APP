...
<br/>
  ...
  <div class="col-xl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="post" action="{{ route('search-annual-school-bus-rental') }}">
          @csrf
        ...
        <label for="html5-month-input">Year</label>
          ...
          <a href="{{ route('school.annual.bus.rentals.reports')}}"  class="btn btn-success">Reset</a>
        </form>
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="card">
            ...
            <tr>
                ...
                $price_total_yearly = App\Models\car_rental_bookings::where('month',$value->month)->where('school_id',Auth::user()->id)->sum('pricetotal');
