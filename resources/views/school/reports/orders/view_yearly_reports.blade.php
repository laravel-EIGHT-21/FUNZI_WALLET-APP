...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Orders</a> /View/</span>Yearly School Orders Reports
            </h4>
...
<br />
            ...
            <div class="row">
                        ...
                        <div class="col-xl-12">
    <h4 class="text"><b>Yearly Orders Reports</b></h4>
  ...
  <div class="col-xl">
    <div class="card mb-4">
      ...
      <div class="card-body">
      <form method="post" action="{{ route('search-school-orders-by-year') }}">
  @csrf
...
<a href="{{ route('school.yearly.orders.reports')}}"  class="btn btn-success">Reset</a>
...
<br/><br/>
    ...
    <div class="col-xl-12">
    <h4 class="text"><b>Yearly Orders Report</b></h4>
...
$total = App\Models\order_items::where('month',$value->month)->where('school_id',$value->school_id)->sum('pricetotal');
