...
Weekly Students PocketMoney Transactions Report
...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Transactions</a> /View/</span>Weekly Students PocketMoney Transactions Reports
            </h4>
...
<br/>
            ...
            <div class="row">
                        ...
                        <div class="col-xl-12">
    <h4 class="text"><b>Weekly Students PocketMoney Transactions Report</b></h4>
  ...
  <div class="col-xl">
    <div class="card mb-4">
      ...
      <div class="card-body">
      <form method="post" action="{{ route('search-pocketmoney-transfers-by-week') }}">
                                                  @csrf
