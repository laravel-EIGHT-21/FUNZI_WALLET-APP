...
PocketMoney Transfer Amounts Details | funziwallet
...
@endsection
      ...
      <h4 class="py-3 mb-4">
              <span class="text-muted fw-light">Details /</span> For PocketMoney Amounts Received
            </h4>
...
<a href="{{ route('recent.school.pocketmoney.transactions')}}" class="btn rounded-pill btn-primary" style="float:right;"><i class='tf-icons mdi mdi-arrow-left mdi-20px'></i>Back</a>
    ...
    <defs>
      ...
      <linearGradient id="paint1_linear_2989_100980" x1="5.19475" y1="0.849139" x2="10.3357" y2="24.1155" gradientUnits="userSpaceOnUse">
        ...
        <stop offset="1" stop-opacity="0" />
          ...
          <div>
          <h4 class="fw-medium">INVOICE #{{$sent_pocketmoney['0']['transfer_invoice']}}</h4>
    <div class="mb-2">
      <span class="text-muted">Invoice Date:</span>
      <span class="fw-medium">{{$sent_pocketmoney['0']['transfer_date']}}</span>
    </div>
    <div>
...
<div class="row">
  <div class="col-12">
    ...
    <span><b>POCKETMONEY TRANSFERED AMOUNT REPORT</b></span>
  </div>
</div>
    ...
    <table>
      <tbody>
        <tr>
          ...
          <td class="fw-medium">{{$sent_pocketmoney['0']['school']['name']}}</td>
        </tr>
        <tr>
          <td class="pe-3">School ID:</td>
          <td>{{$sent_pocketmoney['0']['school']['school_id_no']}}</td>
        </tr>
        <tr>
          <td class="pe-3">Tel 1:</td>
          <td>{{$sent_pocketmoney['0']['school']['school_tel1']}}</td>
        </tr>
        <tr>
          <td class="pe-3">Tel 2:</td>
          <td>{{$sent_pocketmoney['0']['school']['school_tel2']}}</td>
        </tr>
        <tr>
          <td class="pe-3">Address:</td>
          <td>{{$sent_pocketmoney['0']['school']['school_address']}}</td>
        </tr>
      </tbody>
    </table>
          </div>
    ...
    <table>
      ...
      <tr>
          ...
          <td>{{$sent_pocketmoney['0']['transfer_date']}}</td>
        </tr>
        <tr>
          <td class="pe-3">Total Deposit:</td>
          <td class="fw-medium">ugx {{ ($pocketmoney_details) }}</td>
        </tr>
        <tr>
      ...
      <div class="table-responsive">
        ...
        <th>Amount Sent </th>
          ...
          @foreach($sent_pocketmoney_details as $key => $value )
    <tbody>
  ...
  <div class="col-xl-3 col-md-4 col-12 invoice-actions">
    <div class="card">
      <div class="card-body">
        <a href="{{route('pocketmoney_transfer.sent.print.report',$sent_pocketmoney['0']['transfer_invoice'])}}"  target="_blank" class="btn btn-success d-grid w-100 mb-3">
