...
Monthly Mobile Money SchoolFees Payments Report
...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Transactions</a> /View/</span>Monthly Mobile Money SchoolFees Payments Reports
            </h4>
...
<br/>
            ...
            <div class="row">
                        ...
                        <div class="col-xl-12">
    <h4 class="text"><b>Monthly Students SchoolFees Transactions Report</b></h4>
  ...
  <div class="col-xl">
    <div class="card mb-4">
      ...
      <form method="post" action="{{ route('search-schoolfees-transfers-by-month') }}">
  @csrf
...
<br/><br/>
    ...
    <div class="col-xl-12">
    <h4 class="text"><b>SchoolFees Monthly Reports</b></h4>
