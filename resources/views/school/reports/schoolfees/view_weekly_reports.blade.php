...
Weekly Mobile Money SchoolFees Payments Report
...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Transactions</a> /View/</span>Weekly Mobile Money SchoolFees Payments Reports
            </h4>

            
            
          
            <h5 class="py-3 mb-2"> SchoolFees Transactions</h5>
<div class="row gy-4">
...
<br/>
            ...
            <div class="row">
                        ...
                        <div class="col-xl-12">
    <h4 class="text"><b>Weekly Students SchoolFees Transactions Report</b></h4>
...
<form method="post" action="{{ route('search-schoolfees-transfers-by-week') }}">
  @csrf
<div class="form-floating form-floating-outline mb-4">
<input class="form-control" type="date" name="start_date" id="html5-date-input" required />
<label for="html5-date-input">Start Date</label>
</div>
<div class="form-floating form-floating-outline mb-4">
<input class="form-control" type="date" name="end_date" id="html5-date-input" required />
...
<br/><br/>
    ...
    <div class="col-xl-12">
    <h4 class="text"><b>SchoolFees Weekly/Daily Reports</b></h4>
...
$depo_total = App\Models\school_fees_collections::where('school_id',$value->school_id)->where('date',$value->date)->sum('amount');
  ...
  <div class="col-xl-12">
  <h4 class="text">SchoolFees Deposits BarChart Report</b></h4>
...
backgroundColor: 'rgb(219, 112, 147,0.8)',
borderColor         : 'rgba(219, 112, 147,1)',
 pointColor          : 'rgba(219, 112, 147,0.8)',
pointHighlightFill  : '#fff',
pointHighlightStroke: 'rgba(219, 112, 147,0.8)',
borderWidth: 2,
