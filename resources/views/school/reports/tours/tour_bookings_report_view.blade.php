...
@endphp
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('dashboard')}}">Home</a> /View/</span>
              Annual School Tour Bookings Report
            </h4>
...
<br/>
  ...
  <div class="col-xl">
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form method="post" action="{{ route('search-annual-school-tour') }}">
          @csrf
        ...
        <label for="html5-month-input">Year</label>
          ...
          <a href="{{ route('school.annual.tours.reports')}}"  class="btn btn-success">Reset</a>
        </form>
      </div>
    </div>
  </div>
...
<div class="row">
  ...
  <div class="card">
            ...
            <tr>
                ...
                $stud_price_total_yearly = App\Models\tours_packs::where('month',$value->month)->where('school_id',Auth::user()->id)->sum('stud_pricetotal');


                $adult_price_total_yearly = App\Models\tours_packs::where('month',$value->month)->where('school_id',Auth::user()->id)->sum('adult_pricetotal');
