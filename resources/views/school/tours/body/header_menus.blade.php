...
<span style="color:var(--bs-primary);">
  ...
  <ul class="menu-inner py-1">
    <!-- Dashboards -->
    <li class="menu-item {{($route == 'tours.travels.dashboard')? 'active':''}}">
      <a href="{{route('tours.travels.dashboard')}}" class="menu-link ">
    ...
    <!-- School Tours -->
    <li class="menu-item {{($route == 'school.tour.packages')? 'active':''}}">
      <a href="{{route('school.tour.packages')}}" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons ri-bus-2-line"></i>
        <div data-i18n="Tour Packages">Tour Packages</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item {{($route == 'school.tour.packages')? 'active':''}}">
          <a href="{{route('school.tour.packages')}}" class="menu-link" >
            <div data-i18n="All Tour Packages">All Tour Packages</div>
          </a>
        </li>

        <li class="menu-item {{($route == 'filter.tour.packages')? 'active':''}}">
          <a href="{{route('filter.tour.packages')}}" class="menu-link" >
            <div data-i18n="Filter Tours">Filter Tours</div>
          </a>
        </li>


        <li class="menu-item {{($route == 'view.tour.bookings')? 'active':''}}">
          <a href="{{route('view.tour.bookings')}}" class="menu-link">
            <div data-i18n="Tour Bookings">Tour Bookings</div>
          </a> 
        </li>


        <li class="menu-item {{($route == 'view.tour.cart')? 'active':''}}">
          <a href="{{route('view.tour.cart')}}" class="menu-link">
            <div data-i18n="Tour Cart">Tour Cart</div>
          </a>
        </li>

        
        <li class="menu-item {{($route == 'view.tour.booking.payments')? 'active':''}}">
          <a href="{{route('view.tour.booking.payments')}}" class="menu-link">
