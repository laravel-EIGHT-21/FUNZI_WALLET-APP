      ...
      @endphp
          ...
          <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-2 me-xl-1">
            <a class="nav-link btn btn-text-secondary btn-icon dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
              <span class="position-absolute top-0 start-50 translate-middle-y badge badge-dot bg-success mt-2 ">{{$tourCartCout}}</span>
            ...
            <ul class="dropdown-menu dropdown-menu-end py-0">
              <li class="dropdown-menu-header border-bottom">
                <div class="dropdown-header d-flex align-items-center py-3">
                  <h6 class="mb-0 me-auto">My Tour Cart</h6>
              ...
              <li class="dropdown-menu-footer border-top p-2">
                <a href="{{ route('view.tour.cart')}}" class="btn btn-success d-flex justify-content-center"> 
                  <i class='tf-icons mdi mdi-cart-arrow-right mdi-20px'></i> Tour Cart
                </a>
              </li>
            </ul>
          </li>
