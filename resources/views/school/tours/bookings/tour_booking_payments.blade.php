...
Tour Bookings Mobile Payments Transactions
...
@endphp 
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{route('tours.travels.dashboard')}}">Home</a> /View /</span>Tour Bookings Mobile Payments
            </h4>
