...
Tour Agency Details | funziwallet
...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <h4 class="py-3 mb-2">
        <span class="text-muted fw-light"><a href="{{route('tours.travels.dashboard')}}">Home</a> /</span> {{$agency->name}} Details
        </h4>
        ...
        <div class="app-academy">
          <div class="card p-0 mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('tour.agency.packages.filtered') }}">

                    <input class="form-control" type="hidden" name="id" id="html5-month-input" value="{{$agency->id}}" />
          ...
          <div class="col-md-2">
            <div class="form-floating form-floating-outline mb-4">
                ...
                <label for="html5-month-input">Max Student Price</label>
                  ...
                  <a href="{{ route('tour.agency.package.details',$agency->id)}}"  class="btn btn-success">Reset</a>
        ...
        <div class="row">
          <div class="col-xl-12">
            <h5 class="text-bold">All Tour Packages Available From {{$agency->name}} </h5>
