...
@endsection
        ...
        <!-- Content -->
          ...
          <h4 class="py-3 mb-4"><span class="text-muted fw-light"><a href="{{route('tours.travels.dashboard')}}">Home</a>/All/</span> Tour Packages</h4>
...
<br />
                        ...
                        <div class="d-flex flex-column flex-md-row gap-3 text-nowrap flex-wrap flex-md-nowrap  flex-lg-wrap flex-xxl-nowrap">
                          ...
                          $school_id = Auth::user()->id;
                          $tourCart2 = App\Models\tours_cart::where('school_id',$school_id)->where('tour_package_id',$tourss->id)->first();
                          ...
                          @if($tourCart2 == null)
                            ...
                            <a href="{{url('school/tour/package/details/'.$tourss->id)}}">
                                <button type="button" title="Add To Tour Cart" class="w-100 btn btn-primary d-flex align-items-center">
                                <i class="ri-bus-fill lh-1 scaleX-n1-rtl ri-24px"></i>
                                Add To Tour Cart
                                </button>
