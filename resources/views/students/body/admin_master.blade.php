...
<link rel="stylesheet" href="{{asset('Admin/assets/vendor/libs/bootstrap-select/bootstrap-select.css')}}" />
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('Admin/assets/photoswipe/photoswipe.css')}}">
...
<div class="layout-wrapper layout-content-navbar  ">
  ...
  @include('students.body.header_menus')
...
<script src="{{asset('Admin/assets/cdn.datatables.net/buttons/1.5.1/js/dataTables.buttons.min.js')}}"></script>
    ...
    <script src="{{asset('Admin/assets/photoswipe/photoswipe.min.js')}}"></script>
    <script src="{{asset('Admin/assets/photoswipe/photoswipe-ui-default.min.js')}}"></script>
    <script src="{{asset('Admin/assets/photoswipe/photoswipe.js')}}"></script>
