...
<span style="color:var(--bs-primary);">
  ...
  <ul class="menu-inner py-1">
    <!-- Dashboards -->
    <li class="menu-item {{($route == 'student.dashboard')? 'active':''}}">
    ...
    <li class="menu-header fw-medium mt-4">
      ...
      <li class="menu-item {{($route == 'view.my.files')? 'active':''}}">
      <a href="{{ route('view.my.files') }}" class="menu-link">
    ...
    <li class="menu-item {{($route == 'my.dropbox.account')? 'active':''}}">
      <a href="{{ route('my.dropbox.account') }}" target="_blank" class="menu-link">
        <i class="menu-icon tf-icons mdi mdi-vector-arrange-below"></i>
        <div data-i18n="Dropbox Account">Dropbox Account</div>
      </a>
    </li>
    ...
    <li class="menu-item {{($route == 'google.drive.redirect')? 'active':''}}">
      <a href="{{ route('google.drive.redirect') }}" target="_blank" class="menu-link">
        <i class="menu-icon tf-icons mdi mdi-vector-arrange-below"></i>
        <div data-i18n="Google Drive Acct">Google Drive Acct</div>
      </a>
    </li>
