...
@endsection
        ...
        <h4 class="py-3 mb-4">
              <span class="text-muted fw-light"><a href="{{ route('dashboard')}}">FunziWallet</a>/View /</span> All  Academics / Others Files Manager &nbsp;  {{ count($allData) }} items
            ...
            <div class="mb-4">
                <a href="{{ route('view.files.board') }}" class="btn rounded-pill btn-warning" style="float:left;">
                  View Academics Board</a>
                                      </div>
...
<div class="ms-3">
<a href="{{ (!empty($value->files))? url('upload/students/student_files/'.$value->files):url('upload/no_image.jpg') }}" target="_blank">
