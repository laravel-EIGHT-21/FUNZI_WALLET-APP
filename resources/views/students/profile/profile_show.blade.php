...
@endsection
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                    @php
                    $id = Auth::user()->id;
                    $adminData = App\Models\Students::find($id);
                    $editData = App\Models\Students::find($id);
    ...
    <div class="tab-content">
      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          <img src="{{ (!empty($adminData->profile_photo_path))? url('upload/student_images/'.$adminData->profile_photo_path):url('upload/user.png') }}" alt="user-avatar" class="d-block w-px-120 h-px-120 rounded" id="uploadedAvatar" />
          ...
          <div class="row mt-2 gy-4">
            ...
            <div class="col-md-6">
              <div class="input-group input-group-merge">
                <div class="form-floating form-floating-outline">
                  <input type="text" id="student_tele" name="telephone" value="{{ $editData->telephone}}" class="form-control" maxlength="13" minlength="13" placeholder="+25670000000" required />
                  <label for="student_tele">Telephone 1</label>
                </div>
            ...
            <div class="col-md-6">
              <div class="input-group input-group-merge">
                <div class="form-floating form-floating-outline">
                  <input type="text" id="student_tele2" name="telephone2" value="{{ $editData->telephone2}}" class="form-control" maxlength="13" minlength="13" placeholder="+25670000000" required />
                  <label for="student_tele2">Telephone 2</label>
                </div>
