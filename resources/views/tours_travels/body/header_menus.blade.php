...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ">
    <a href="{{ route('tour.operator.dashboard')}}" class="app-brand-link">
...
<span style="color:var(--bs-primary);">
  <svg width="268" height="150" viewBox="0 0 38 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      ...
      <span class="app-brand-text demo menu-text fw-bold ms-2">Funzi Tours</span>
    </a>

    <a href="{{ route('tour.operator.dashboard') }}" class="layout-menu-toggle menu-link text-large ms-auto">
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{($route == 'tour.operator.dashboard')? 'active':''}}">
      <a href="{{route('tour.operator.dashboard')}}" class="menu-link ">
    ...
    <!-- School Tours -->
    <li class="menu-item {{($route == 'view.tour.package')? 'active':''}}">
      <a href="{{route('view.tour.package')}}" class="menu-link menu-toggle">
        <i class="menu-icon tf-icons ri-bus-2-line"></i>
        <div data-i18n="School Tours">School Tours</div>
      </a>
      <ul class="menu-sub">
        <li class="menu-item {{($route == 'add.tour.package')? 'active':''}}">
          <a href="{{route('add.tour.package')}}" class="menu-link" >
            <div data-i18n="Add New Package">Add New Package</div>
          </a>
        </li>

        <li class="menu-item {{($route == 'view.tour.package')? 'active':''}}">
          <a href="{{route('view.tour.package')}}" class="menu-link">
            <div data-i18n="View All Packages">View All Packages</div>
          </a>
        </li>

        <li class="menu-item {{($route == 'school-tours-bookings')? 'active':''}}">
          <a href="{{route('school-tours-bookings')}}" class="menu-link">
            <div data-i18n="School Bookings">School Bookings</div>
          </a> 
        </li>

        <li class="menu-item {{($route == 'tour.all.review')? 'active':''}}">
          <a href="{{route('tour.all.review')}}" class="menu-link">
            <div data-i18n="Tour Reviews">Tour Reviews</div>
          </a> 
        </li>

        <li class="menu-item {{($route == 'tour.bookings.reports')? 'active':''}}">
          <a href="{{route('tour.bookings.reports')}}" class="menu-link">
