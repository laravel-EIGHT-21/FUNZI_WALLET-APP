...
@endsection
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
                    @php
                    $id = Auth::user()->id;
                    $adminData = App\Models\TourOperator::find($id);
                    $editData = App\Models\TourOperator::find($id);
    ...
    <div class="tab-content">
      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          <img src="{{ (!empty($adminData->profile_photo_path))? url('upload/tour_operators/'.$adminData->profile_photo_path):url('upload/no_image.jpg') }}" alt="user-avatar" class="d-block w-px-150 h-px-170 rounded"  />
...
<div class="tab-pane fade" id="navs-pills-justified-security" role="tabpanel">
 ...
 <div class="card mb-4" >
      ...
      <div class="card-body">
      <form method="POST" action="{{route('operator.password.update') }}" enctype="multipart/form-data" >
        @csrf
          <div class="row">
...
<!--/ Enable OTP Modal -->
    ...
    <!--/ Two-steps verification -->
                      ...
                      <script src="{{asset('Tours/assets/js/modal-enable-otp.js')}}"></script>
  <script src="{{asset('Tours/assets/js/pages-account-settings-account.js')}}"></script>
  <script src="{{asset('Tours/assets/js/pages-account-settings-security.js')}}"></script>
